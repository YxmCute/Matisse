...
public class MatisseActivity extends AppCompatActivity implements
  ...
  public static final  String                 EXTRA_RESULT_SELECTION       =
      "extra_result_selection";
  public static final  String                 EXTRA_RESULT_SELECTION_PATH  =
      "extra_result_selection_path";
  public static final  String                 EXTRA_RESULT_ORIGINAL_ENABLE =
      "extra_result_original_enable";
  ...
  private              SelectedItemCollection mSelectedCollection          =
      new SelectedItemCollection(this);
  ...
  private final ArrayList<Uri> mPathUriList = new ArrayList<>();
    ...
    if (requestCode == REQUEST_CODE_PREVIEW) {
      ...
      if (data.getBooleanExtra(BasePreviewActivity.EXTRA_RESULT_APPLY, false)) {
        ...
        if (selected != null) {
          ...
          if (mSelectNumber == 1 && mSpec.isCrop && !hasVideo) {
            //需要裁剪
            mPathList.add(CropUtils.CropPhoto(selectedUris.get(0), MatisseActivity.this,
                mSpec.captureStrategy.authority, REQUEST_CODE_CROP));
            return;
          }
  ...
  private final OnCompressListener mOnCompressListener = new OnCompressListener() {
    @Override
    public void onStart() {
    ...
    if (v.getId() == R.id.button_preview) {
      ...
      if (mSelectNumber > 0) {
        ...
        if (!isVideo && mSelectNumber == 1 && mSpec.isCrop) {
          //需要裁剪
          mPathList.add(
              CropPhoto(selectedUris.get(0), MatisseActivity.this, mSpec.captureStrategy.authority,
                  REQUEST_CODE_CROP));
          return;
        }
        try {
